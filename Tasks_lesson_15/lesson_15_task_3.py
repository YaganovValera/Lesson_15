...
class Rectangle:
    ...
    def width(self, value):
        if value < 0:
            raise ValueError("Ширина должна быть положительной, а не " + str(value))
        self._width = value
    ...
    def height(self, value):
        if value < 0:
            raise ValueError("Высота должна быть положительной, а не " + str(value))
        self._height = value
...
if __name__ == "__main__":
    ...
    parser.add_argument("--height1", type=int, help="Height of the first rectangle")
    parser.add_argument("--width2", type=int, help="Width of the second rectangle")
    parser.add_argument("--height2", type=int, help="Height of the second rectangle")

    args = parser.parse_args()
    logging.basicConfig(level=logging.NOTSET)
    try:
        rectangle1 = Rectangle(args.width1, args.height1)
        rectangle2 = Rectangle(args.width2, args.height2)

        logging.info("Прямоугольник №1: %s", rectangle1)
        logging.info("Прямоугольник №2: %s", rectangle2)

        result = rectangle1 + rectangle2
        logging.info("Сумма прямоугольников: %s", result)

        difference = rectangle1 - rectangle2
        logging.info("Разница прямоугольников: %s", difference)

    except ValueError as e:
        logging.error(str(e))

# Введите в терминал:
# python lesson_15_task_3.py --width1 5 --height1 3 --width2 8 --height2 4
